    ...
    try {
      final requestBody = {
        ...
        'messages': [
          {
            'role': 'system',
            'content': 'You are a helpful assistant that creates concise, informative summaries of audio transcripts. Focus on key points, main topics, and important details. Keep the summary clear and well-structured.'
          },
          {
            'role': 'user',
